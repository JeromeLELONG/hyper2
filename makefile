...
exec-e2e:
	...
	docker-compose  -f docker-compose-production.yml exec apache bash -ci 'cd /usr/lib/node_modules/protractor/node_modules/webdriver-manager/selenium/ && unzip /usr/lib/node_modules/protractor/node_modules/webdriver-manager/selenium/chromedriver_2.42.zip'
	docker-compose  -f docker-compose-production.yml exec apache bash -ci 'cd /usr/lib/node_modules/protractor/node_modules/webdriver-manager/selenium/ && tar -zxvf /usr/lib/node_modules/protractor/node_modules/webdriver-manager/selenium/geckodriver-v0.23.0.tar.gz'
	docker-compose  -f docker-compose-production.yml exec apache bash -ci 'mv /usr/lib/node_modules/protractor/node_modules/webdriver-manager/selenium/chromedriver /usr/lib/node_modules/protractor/node_modules/webdriver-manager/selenium/chromedriver_2.42'
	docker-compose  -f docker-compose-production.yml exec apache bash -ci 'mv /usr/lib/node_modules/protractor/node_modules/webdriver-manager/selenium/geckodriver /usr/lib/node_modules/protractor/node_modules/webdriver-manager/selenium/geckodriver-v0.23.0'
	docker-compose  -f docker-compose-production.yml exec apache bash -ci 'cp /usr/src/node_modules/selenium-server-standalone-jar/jar/selenium-server-standalone-3.14.0.jar /usr/lib/node_modules/protractor/node_modules/webdriver-manager/selenium/selenium-server-standalone-3.14.0.jar'
	docker-compose  -f docker-compose-production.yml exec apache bash -ci 'rm -rf /var/www/html/applications/hyper/data/*.zip 2> /dev/null || echo > /dev/null' 
	docker-compose  -f docker-compose-production.yml exec apache bash -ci 'rm -rf /var/www/html/applications/hyper/data/*.xlsx 2> /dev/null || echo > /dev/null' 
	docker-compose  -f docker-compose-production.yml exec apache bash -ci 'rm -rf /var/www/html/applications/hyper/data/*.csv 2> /dev/null || echo > /dev/null' 
	docker-compose  -f docker-compose-production.yml exec apache bash -ci 'cd /usr/src/e2e && protractor'
...
test: build-node-app build-image test-unit test-e2e